...
const App: React.FC = () => {
  ...
  const handleLogin = useCallback(() => {
    ...
    window.FB.login((response: any) => {
        ...
        scope: 'business_management,email,instagram_basic,instagram_content_publish,instagram_manage_comments,instagram_manage_insights,pages_manage_posts,pages_messaging,pages_read_engagement,pages_read_user_content,pages_show_list,public_profile,read_insights,user_messenger_contact',
        auth_type: 'rerequest'
      });
  }, [isSimulationMode]);
